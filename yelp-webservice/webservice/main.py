...
def start_service():
	...
	# business_reviews
	dispatcher.connect('biz_rev_get', '/business_reviews/:bid/attribute/:attribute', controller=bizreviewController,
                        action = 'GET_BID', conditions=dict(method=['GET']))
	...
	dispatcher.connect('opt_rid_del','/reviews/:rid',
		...
		action = 'OPTIONS',
		conditions=dict(method=['OPTIONS']))
	dispatcher.connect('opt_biz_rev_get','/business_reviews/:bid/attribute/:attribute',
		controller=optController,
		action = 'OPTIONS',
		conditions=dict(method=['OPTIONS']))
